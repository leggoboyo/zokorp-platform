...
- [TODO][AUTO] CRIT-002 Implement browser-side PNG text extraction for the Architecture Diagram Reviewer. Done when: PNG OCR runs in the browser, progress is visible in the UI, and no server OCR is required for PNG uploads.
