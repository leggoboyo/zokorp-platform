...
- Scope:
  - replaced process-local `Map` limiter with shared Postgres-backed limiter in [`lib/rate-limit.ts`](/Users/zohaibkhawaja/Documents/Codex/zokorp-platform/lib/rate-limit.ts)
  - added `RateLimitBucket` Prisma model and migration in [`prisma/schema.prisma`](/Users/zohaibkhawaja/Documents/Codex/zokorp-platform/prisma/schema.prisma) and [`prisma/migrations/0009_rate_limit_bucket/migration.sql`](/Users/zohaibkhawaja/Documents/Codex/zokorp-platform/prisma/migrations/0009_rate_limit_bucket/migration.sql)
  - updated rate-limit callers to await async limiter across auth, billing, service, and tool endpoints
  - updated rate-limit test coverage in [`tests/rate-limit.test.ts`](/Users/zohaibkhawaja/Documents/Codex/zokorp-platform/tests/rate-limit.test.ts)
- Preflight:
